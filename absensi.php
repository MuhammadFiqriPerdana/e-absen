...
if (empty($absensiMasukCek) && $jamMasuk >= '17:00:00') {
    ...
    $query = "INSERT INTO tb_absensi VALUE ('', '$nip', '$nama', '$tanggalSekarang', '$jamMasuk', '-', '0', 'tanpa keterangan')";
    mysqli_query($conn, $query);
} else if (empty($absensiMasukCek) && $jamMasuk >= '07:30:00') {
    global $conn;

    $query = "INSERT INTO tb_absensi VALUE ('', '$nip', '$nama', '$tanggalSekarang', '$jamMasuk', 'belum tercatat', '20000', 'terlambat')";
    mysqli_query($conn, $query);
} else if (empty($absensiMasukCek) && $jamMasuk < '07:30:00') {
    global $conn;

    $query = "INSERT INTO tb_absensi VALUE ('', '$nip', '$nama', '$tanggalSekarang', '$jamMasuk', 'belum tercatat', '40000', 'hadir')";
    mysqli_query($conn, $query);
} 
...
if ($cekHari === 'Sat' && empty($absensiMasukCek)) {
    ...
    $query = "INSERT INTO tb_absensi VALUE ('', '$nip', '$nama', '$tanggalSekarang', '-', '-', '', 'Libur')";
    mysqli_query($conn, $query);
...
// if($jamMasuk >= '17:00:00'){
//     global $conn;

//     $query = "INSERT INTO tb_absensi VALUE ('', '$nip', '$nama', '$tanggalSekarang', '$jamMasuk', 'belum tercatat', '0', 'Tanpa Keterangan')";
//     mysqli_query($conn, $query);
// } elseif($jamMasuk <= '07:29:00'){
//     global $conn;

//     $query = "INSERT INTO tb_absensi VALUE ('', '$nip', '$nama', '$tanggalSekarang', '$jamMasuk', 'belum tercatat', '40000', 'Hadir')";
//     mysqli_query($conn, $query);
// } elseif($jamMasuk >= '07:30:00'){
//     global $conn;
