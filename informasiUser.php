...
$query = mysqli_query($conn, "SELECT * FROM pegawai P LEFT JOIN tb_absensi TA ON P.nip = TA.nip  WHERE P.nip = '$nipPegawai'");
$informasi = mysqli_fetch_assoc($query);

$sum = mysqli_query($conn, "SELECT SUM(tunjangan) AS value_sum FROM tb_absensi TA LEFT JOIN pegawai P ON TA.nip = P.nip WHERE P.nip = '$nipPegawai'");
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h5>Tunjangan : Rp. <?= number_format($row['value_sum']) ?></h5>
                            <h5>Gajih: Rp. <?= number_format($informasi['gaji']) ?></h5>
